...
class CardModel {
  ...
  static List<CardModel> sampleCards = [
    CardModel(
      ...
      categories: [CardCategory.congratulation],
    ...
    CardModel(
      ...
      categories: [CardCategory.birthday,],
      bgColor: ColorName.bgOrange,
    ),
    CardModel(
      id: 6,
      ...
      categories: [CardCategory.wedding,],
      bgColor: ColorName.bgOrange,
    ),
    CardModel(
      id: 7,
    ...
    CardModel(
      ...
      categories: [CardCategory.congratulation, CardCategory.chrismas],
      bgColor: ColorName.bgBlue,
    ),
  ];
}